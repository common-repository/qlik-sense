<?php
	...
	*/
    ...
    define( 'QLIK_SENSE_PLUGIN_VERSION', '1.3.2' );
    ...
    function qlik_sense_enqueued_styles() {
        ...
        // $local = basename( dirname( __FILE__ ) ) . "/index.css";
        wp_register_style( 'qlik-sense-styles', $url);
        wp_enqueue_style( 'qlik-sense-custom-style', QLIK_SENSE_PLUGIN_PLUGIN_DIR . "/index.css" );
    }
